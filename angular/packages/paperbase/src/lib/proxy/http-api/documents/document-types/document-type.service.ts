...
export class DocumentTypeService {
  ...
  create = (input: CreateDocumentTypeDto, config?: Partial<Rest.Config>) =>
    this.restService.request<any, DocumentTypeDto>({
      method: 'POST',
      url: '/api/paperbase/document-types',
      body: input,
    },
  ...
  delete = (id: string, config?: Partial<Rest.Config>) =>
    this.restService.request<any, void>({
      method: 'DELETE',
      url: `/api/paperbase/document-types/${id}`,
    },
    { apiName: this.apiName,...config });
  ...
  getDeleted = (config?: Partial<Rest.Config>) =>
    this.restService.request<any, DocumentTypeDto[]>({
      method: 'GET',
      url: '/api/paperbase/document-types/deleted',
    },
    { apiName: this.apiName,...config });
  ...
  restore = (id: string, config?: Partial<Rest.Config>) =>
    this.restService.request<any, DocumentTypeDto>({
      method: 'POST',
      url: `/api/paperbase/document-types/${id}/restore`,
    },
    { apiName: this.apiName,...config });
