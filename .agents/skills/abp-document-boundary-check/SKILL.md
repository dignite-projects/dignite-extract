...
`AGENTS.md` defines a mandatory constraint:
...
3. **If a violation is found, give a migration recommendation**
   ...
   - A reference to the relevant `AGENTS.md` section for user review.
...
- Root `AGENTS.md` -> "Field architecture", "Markdown-first", and "OUT of scope"
- `.Codex/rules/ddd-patterns.md` -> aggregate design and DDD invariants
- `.Codex/rules/dependency-rules.md` -> cross-layer and cross-module dependency direction
