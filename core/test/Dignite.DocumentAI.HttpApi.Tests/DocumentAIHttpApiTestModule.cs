...
/// (<see cref="DocumentAIHttpApiModule"/>) on top of the reused EF Core test module (in-memory SQLite +
...
[DependsOn(
    ...
    typeof(DocumentAIEntityFrameworkCoreTestModule)
)]
public class DocumentAIHttpApiTestModule : AbpModule
{
