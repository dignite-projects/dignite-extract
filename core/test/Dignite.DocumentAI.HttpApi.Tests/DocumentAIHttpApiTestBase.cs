...
/// <see cref="DocumentAIHttpApiTestModule"/> and exposes a <c>Client</c>
...
public abstract class DocumentAIHttpApiTestBase : AbpAspNetCoreIntegratedTestBase<DocumentAIHttpApiTestModule>
